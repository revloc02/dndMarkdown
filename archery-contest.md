...
<div class="wide" style='margin-top:780px;'></div>

#### Rules

* Make range attacks, score according to AC
* Highest sum of multiple shots wins
* A critical hit (20) adds an extra die (DM's choice)
* A critical miss (1) subtracts an extra die (DM's choice)
* Archery feats grant Advantage on all shots

\columnbreak

#### Options
* Course Modifier - a standard bonus or penalty for all shots
* Wind - a penalty die (DM's choice) for all shots
* Momentum - archer with best shot of round gets +1 for next shot
* Crowd Support - DC 15 Cha to gain Advantage on one shot per contest
* Intimidation - Disadvantage to loser of opposed Cha check
* Magic - DM's descretion for magic items and buffs
...
#### Course Mechanics
* **Course Modifier:** The DM may identify a Course Modifier bonus of +1 to +6 for all shots, indicating an easier or shorter archery range. Alternatively the DM can apply a Course Modifier penalty or -1 to -3, indicating a more challenging or longer ranges.
* **Wind:** Wind could be a factor if desired and every shot would have a negative die imposed such as a d4 or d6. (This rule is especially effective in conjunction with a Course Modifier, e.g. Course Modifier of +4, with Wind of -1d4.)
