...
#### Course Mechanics
* **Field Modifier:** The DM may identify a Field Modifier bonus of +1 to +6 for all shots, indicating an easier or shorter archery range. Alternatively the DM can apply a Field Modifier penalty or -1 to -3, indicating a more challenging or longer ranges.
* **Wind:** Wind could be a factor if desired and every shot would have a negative die imposed such as a d4 or d6. (This rule is especially effective in conjunction with a Field Modifier, e.g. Field Modifier of +4, with Wind of -1d4.)

#### Tournament Mechanics
* **Alternate Scoring:** Tourneys can also be the sum of 3 or 7 shots.
* **Varying Ranges:** A tournament could progress over multiple different ranges as shooting rounds proceed. Change the Field Modifier appropriately as the range changes per shooting round.
