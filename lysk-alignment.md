...
### Chaotic Neutral
Creatures are interested in fulfilling their desires, and in pursuing their own interests, maintaining their personal freedom with only a passive consideration of conscience.
* **Hedonist** or Lunatic - The ultimate free spirits that are not overly concerned with morality
* Ex. Creature: **Slaadi**, Satyr, pirates, mad hermit
* Pop Culture Ex.: **Captain Jack Sparrow**, Conan

<img src='https://www.gmbinder.com/images/HtOoVyj.jpg' style='position:absolute;top:100px;right:50px;width:350px; mix-blend-mode:multiply;filter:brightness(100%)saturate(100%)opacity(50%);transform:rotate(0deg)scaleX(1)scaleY(0.68);' />
