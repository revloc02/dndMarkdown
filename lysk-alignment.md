...
<img src='https://www.gmbinder.com/images/dWXbtL0.png' style='position:absolute;top:361px;left:50px;width:350px; mix-blend-mode:multiply;filter:brightness(100%)saturate(100%)opacity(15%);transform:rotate(0deg)scaleX(1)scaleY(1.13);' />
...
<img src='https://www.gmbinder.com/images/ZOUjaYg.png' style='position:absolute;top:198px;right:50px;width:350px; mix-blend-mode:multiply;filter:brightness(100%)saturate(100%)opacity(10%);transform:rotate(0deg)scaleX(1)scaleY(1.05);' />
