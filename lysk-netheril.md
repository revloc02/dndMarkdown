...
<img src='https://www.gmbinder.com/images/1pC6pvT.png' style='position:absolute;top:20px;right:0px;width:400px; mix-blend-mode:multiply;filter:brightness(120%)saturate(130%);transform:rotate(0deg)scaleX(-1)scaleY(1);' />
...
Broken and shattered, it took the Netherese people a while to regroup, but eventually came the most recent age, the Re-Emergence of the Empire.
...
<img src='https://i.imgur.com/73aD8Be.jpg' style='position:absolute;bottom:20px;right:0px;width:400px; mix-blend-mode:multiply;filter:brightness(120%)saturate(130%);transform:rotate(0deg)scaleX(-1)scaleY(1);' />
