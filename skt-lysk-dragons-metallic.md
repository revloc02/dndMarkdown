...
<img src='https://www.gmbinder.com/images/Xx4EvqS.png' style='position:absolute;top:370px;right:-20px;width:458px; mix-blend-mode:multiply;filter:brightness(120%)saturate(100%);transform:rotate(0deg)scaleX(-1)scaleY(1);' />
...
<img src='http://francklebon.f.r.pic.centerblog.net/q3884kyc.jpg' style='position:absolute;bottom:38px;right:0px;width:410px; mix-blend-mode:multiply;filter:brightness(120%)saturate(120%);' />
