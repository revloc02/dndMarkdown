...
<img src='https://www.gmbinder.com/images/qHyqd4o.jpg' style='position:absolute;bottom:10px;right:-80px;width:500px; mix-blend-mode:multiply;filter:brightness(140%)saturate(130%);transform:rotate(0deg)scaleX(-1)scaleY(1);' />
...
<img
   ...
   right:180px;
   width:100px;
   transform:scaleX(15)scaleY(1);'
/>

#### Blue Dragon

<img src='https://vignette.wikia.nocookie.net/forgottenrealms/images/3/37/Monster_Manual_5e_-_Dragon%2C_Blue_-_p90.jpg/revision/latest?cb=20141111150833' style='position:absolute;top:0px;right:-40px;width:550px; mix-blend-mode:multiply;filter:brightness(120%)saturate(100%);' />

* **Alignment**: Lawful Evil
* **Habitat:** deserts, dry steppes, searing badlands
* **Breath Weapon:** Poison

**Vain and Territorial Overlords:** A blue dragon will not stand for any remark or insinuation that it is weak or inferior, taking great pleasure in lording its power over humanoids and other lesser creatures.

#### Red Dragon

<img src='https://www.gmbinder.com/images/6JyfbYa.jpg' style='position:absolute;top:300px;right:0px;width:440px; mix-blend-mode:multiply;filter:brightness(120%)saturate(110%);' />
